...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/gogolnr1/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/gogolnr1/LARBS/master/progs.csv"
